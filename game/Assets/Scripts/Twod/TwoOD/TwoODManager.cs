...
public class TwoODManager : MonoBehaviour
{
    public Text nameText;
    public Text dialogueText;
    public GameObject dialoguePanel;
    public TwoODData dialogueData;
    ...
    public void ShowDialogue()
    {
        ...
        TwoODLine line = dialogueData.dialogues[currentIndex];

        // 如果是第7条对话，隐藏对话按钮并显示切换场景按钮
        if (currentIndex == 7)
        {
    ...
    IEnumerator FadeInText(string content, string speaker)
    {
        ...
        while (alpha < 1f)
        {
            ...
            Color fadeColor = new Color(0f, 0f, 0f, alpha);  // 透明度渐变
